  ...
  return (
    <main className="layout-container flex min-h-screen flex-col gap-12 lg:gap-16">
      ...
      <header className="hero-section relative px-6 py-10 text-center sm:px-10 sm:py-12 lg:px-16 lg:py-14">
        ...
        <div
          className="decorative-circle -bottom-10 -right-10 h-32 w-32 animate-float"
        ...
        <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-lg text-lg leading-relaxed text-brand-earth-600 opacity-0 animate-fade-up animate-stagger-2 sm:text-xl">
              Share your offers and desires, enjoy the generosity of giving and
              receiving.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-1 text-center">
              <span className="font-display text-xl font-bold text-brand-earth-900">
                Host a room
              </span>
              <span className="block text-sm text-brand-earth-500">
        ...
        {selectedAction === "host" && (
          ...
          >
            <div className="space-y-2 text-center">
              ...
              <p className="text-brand-earth-500">
                You&apos;ll get a room code to share with others.
              </p>
            </div>
      ...
      <section className="section-card space-y-10">
        ...
        <div className="info-block">
          ...
          <p className="text-lg leading-relaxed text-brand-earth-600">
            A Gift Circle is a gathering where people share gifts with each other in a
            spirit of generosity. It&apos;s a way to build community, support one
            another, and create a culture of abundance.
          </p>
        </div>
        ...
        <div className="info-block">
          ...
          <p className="text-lg leading-relaxed text-brand-earth-600">
            Please bring a list of <span className="pill-green">OFFERS</span> and a list
            of <span className="pill-gold">DESIRES</span> U would be delighted to give
            and receive.
          </p>
          <p className="text-brand-earth-500 leading-relaxed">
            For example: a massage, an hour to be listened to, a friend to go on a road
            trip, money for a project... U are limited only by your imagination!
          </p>
          <p className="text-sm text-brand-earth-400 italic">
            This app works best on a laptop or desktop, but also works on tablets and
            phones.
          </p>
        </div>
        ...
        <div className="info-block">
          ...
          <ol className="format-list">
            ...
            <li className="format-list-item">
              ...
              <span className="font-semibold text-brand-earth-800">
                Welcoming and Guidelines
              </span>
            </li>
            <li className="format-list-item">
              ...
              <span className="text-brand-earth-700">
                ...
                <em className="text-brand-earth-500">
            ...
            <li className="format-list-item">
              ...
              <span className="text-brand-earth-700">
                <span className="font-semibold text-brand-earth-800">
                  Lightning Connections Round 1
                </span>
                <span className="mx-2 text-brand-earth-400">&mdash;</span>
                <em className="text-brand-earth-500">
                  &quot;Mary, I want to take you up on a Listening Session...&quot;
                </em>
              </span>
            </li>
            <li className="format-list-item">
              ...
              <span className="text-brand-earth-700">
                <span className="font-semibold text-brand-earth-800">
                  Lightning Connection Round 2
                </span>
                <span className="mx-2 text-brand-earth-400">&mdash;</span>
                <em className="text-brand-earth-500">
                  &quot;Yes, I&apos;ll be happy to give you a back massage...&quot;
                </em>
              </span>
            </li>
            <li className="format-list-item">
        ...
        <div className="space-y-5 border-t-2 border-brand-earth-100 pt-10">
          <p className="text-lg leading-relaxed text-brand-earth-600">
            This web app is designed to make it smoother for hosts and participants of
            Gift Circles to track which gifts are given by whom, to whom. We hope it
            makes it easier and more enjoyable for U to participate in Gift
            Circles&mdash;and that it inspires more people to do them!
          </p>
          <p className="text-lg leading-relaxed text-brand-earth-600">
            New to Gift Circles? Read{" "}
            <a
              href="https://tasshin.com/blog/the-magic-of-gift-circles/"
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:text-brand-earth-800"
            >
              this blog post
            </a>{" "}
            for more on what they are and how they create magical experiences through
            generosity.
          </p>
          <p className="text-sm text-brand-earth-500">
            ...
            . We learned about Gift Circles through the WEALTH community, led by Carolyn
            Elliott.
          </p>
          <p className="text-sm text-brand-earth-500">
